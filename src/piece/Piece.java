...
public class Piece {
    ...
    public BufferedImage getImage(String imagePath) {
        ...
        try {
            // Prefer classpath resource; fallback to local res/ folder for IDE run modes.
            if (getClass().getResourceAsStream(resourcePath) != null) {
                image = ImageIO.read(getClass().getResourceAsStream(resourcePath));
            } else {
                String localPath = "../res" + resourcePath;
                image = ImageIO.read(new java.io.File(localPath));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
